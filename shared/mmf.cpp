...
BOOL MMF::OpenReadOnly(const char* const pszFileName)
{
   ...
   // Open File
   if ((_hFile = CreateFile(pszFileName,                  // Pointer to Name of the File
   ...
   // Map to Memory
   _hMap = CreateFileMapping(_hFile,           // Handle to File to Map
   ...
   // Create View
   _pView = MapViewOfFile(_hMap,            // File-mapping Object to Map into Address Space
